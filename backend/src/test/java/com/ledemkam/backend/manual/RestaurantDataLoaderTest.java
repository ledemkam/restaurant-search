package com.ledemkam.backend.manual;
...
import com.ledemkam.backend.domain.entities.TimeRange;
...
import com.ledemkam.backend.services.impl.RandomLondonGeoLocationService;
...
class RestaurantDataLoaderTest {
    ...
    @Test
    @Rollback(false) // Permet de persister les changements
    void createSampleRestaurants() throws Exception {
        ...
        restaurants.forEach(restaurant -> {
            ...
            // Appel du service pour uploader la photo
            Photo uploadedPhoto = photoService.uploadPhoto(multipartFile);

            // Assertion : le restaurant créé ne doit pas être nul
            var created = restaurantService.createRestaurant(restaurant);
            org.junit.jupiter.api.Assertions.assertNotNull(created, "Le restaurant créé ne doit pas être nul");
